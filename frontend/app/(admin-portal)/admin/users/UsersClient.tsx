...
import { Plus, Search, Shield, Mail, Calendar, User, Users, UserCheck, UserX, Clock, TrendingUp, Key, Trash2 } from "lucide-react";
...
export default function UsersClient({ users, stats, recentActivity, currentUserRole }: UsersClientProps) {
    const [selectedUserForReset, setSelectedUserForReset] = useState<any>(null);
    const [selectedUserForRoleDelete, setSelectedUserForRoleDelete] = useState<any>(null);
    ...
    return (
        <div className="p-8 space-y-8">
                                    ...
                                    <div className="flex justify-end gap-3">
                                        ...
                                        {isSuperAdmin && (
                                            <>
                                                ...
                                                <button
                                                    onClick={() => setSelectedUserForRoleDelete(user)}
            ...
            {selectedUserForRoleDelete && (
                <DeleteRoleModal
                    user={selectedUserForRoleDelete}
                    isOpen={!!selectedUserForRoleDelete}
                    onClose={() => setSelectedUserForRoleDelete(null)}
