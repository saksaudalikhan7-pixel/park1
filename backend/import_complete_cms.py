"""
Import Complete CMS Data into Production Database
...
def import_complete_cms_data():
    """Import complete CMS data from JSON file"""
    from apps.cms import models as cms_models
    
    # Read the exported data
    with open('complete_cms_export.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    print("\n🎨 Importing Complete CMS Data to Production...")
    print("=" * 60)
